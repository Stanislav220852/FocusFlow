...
from src.api.dependencies import CurrentUserDep,DBSessionDep,RedisDep
...
async def test_redis(cache: RedisDep):
...
async def get_room(room_id: UUID, db: DBSessionDep):
